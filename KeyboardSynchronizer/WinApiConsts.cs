namespace KeyboardSynchronizer {
    public class WinApiConsts {
        ...
        public class Msg {
            ...
            /// <summary>
            /// 按下某键，并已发出  public const int WM_KEYDOWN，   public const int WM_KEYUP消息
            /// </summary>
            public const int WM_CHAR = 0x102;
            /// <summary>
            /// 当用translatemessage函数翻译  public const int WM_KEYUP消息时发送此消息给拥有焦点的窗口
            /// </summary>
            ...
            /// <summary>
            /// 当  public const int WM_SYSKEYDOWN消息被TRANSLATEMESSAGE函数翻译后提交此消息给拥有焦点的窗口
            /// </summary>
            public const int WM_SYSCHAR = 0x106;
            /// <summary>
            /// 当  public const int WM_SYSKEYDOWN消息被TRANSLATEMESSAGE函数翻译后发送此消息给拥有焦点的窗口
            /// </summary>
            ...
            /// <summary>
            /// 移动鼠标时发生，同  public const int WM_MOUSEFIRST
            /// </summary>
            ...
            /// <summary>
            /// 当系统进程发出  public const int WM_QUERYENDSESSION消息后，此消息发送给应用程序，通知它对话是否结束
            /// </summary>
            ...
            /// <summary>
            /// 此消息有一个LBS_WANTKEYBOARDINPUT风格的发出给它的所有者来响应  public const int WM_KEYDOWN消息 
            /// </summary>
            public const int WM_VKEYTOITEM = 0x2E;
            /// <summary>
            /// 此消息由一个LBS_WANTKEYBOARDINPUT风格的列表框发送给他的所有者来响应  public const int WM_CHAR消息 
            /// </summary>
            ...
            /// <summary>
            /// 当某个窗口第一次被创建时，此消息在  public const int WM_CREATE消息发送前发送
            /// </summary>
